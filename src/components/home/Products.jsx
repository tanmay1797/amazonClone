      ...
      {productData.map((item) => (
        ...
        >
          ...
          <div className="w-full h-auto flex items-center justify-center relative group">
            ...
            <ul className="absolute w-full h-36 bg-gray-100 -bottom-[160px] group-hover:bottom-0 duration-700 flex flex-col justify-center items-end gap-2 duration-700">
